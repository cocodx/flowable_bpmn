...
public class Test06 {
    ...
    public void testRunProcess(){
        ...
        //启动流程实例
        ProcessInstance holidayRequest = runtimeService.startProcessInstanceByKey("ceshikey", variables);
//        ProcessInstance holidayRequest = runtimeService.startProcessInstanceByKeyAndTenantId("myTestKey1234", variables, "user1");
    ...
    public void testCompleteTask(){
        ...
        List<Task> taskList = taskService.createTaskQuery().taskAssignee("9").list();
