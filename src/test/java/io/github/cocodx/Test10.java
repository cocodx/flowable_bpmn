...
public class Test10 {
    ...
    public void testDeploy(){
        ...
        Deployment deploy = repositoryService.createDeployment()
                .addClasspathResource("11213123.bpmn20.xml")
                .name("有集合变量，不设置通过条件")
                .deploy()//流程部署
                ;
    ...
    public void testRunProcess(){
        ...
        variables.put("outcome","3");
        //启动流程实例
        ProcessInstance holidayRequest = runtimeService.startProcessInstanceByKey("a123123123", variables);
//        ProcessInstance holidayRequest = runtimeService.startProcessInstanceByKeyAndTenantId("myTestKey1234", variables, "user1");
    ...
    public void testCompleteTask(){
        ...
        taskList.forEach(item->{
            Map<String,Object> variables = new HashMap<>();
            variables.put("outcome1","1");
            variables.put("outcome2","2");
